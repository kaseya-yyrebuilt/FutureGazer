	...
	public class OneClickDAZ : OneClickBase
	{
		...
		public static void Setup(GameObject gameObject, AudioClip clip)
		{
			...
			NewConfiguration(OneClickConfiguration.ConfigType.Salsa);
			{
				...
				NewExpression("w");
				AddShapeComponent(new[] {"head__eCTRLvW", "head__VSMW", "head__CTRLVSMW"}, 0.11f, 0f, 0.07f, "head__eCTRLvW", 1f);
				// emotiguy
				AddShapeComponent(new[] {"head__PuckerLipsWide"}, 0.11f, 0f, 0.07f, "head__PuckerLipsWide", 1f);


				NewExpression("t");
				AddShapeComponent(new[] {"head__eCTRLvT", "head__VSMT", "head__CTRLVSMT"}, 0.11f, 0f, 0.07f, "head__eCTRLvT", 1f);
				// emotiguy
				AddShapeComponent(new[] {"head__MouthTH"}, 0.11f, 0f, 0.07f, "head__MouthTH", 0.709f);
				AddShapeComponent(new[] {"head__PuckerLips"}, 0.11f, 0f, 0.07f, "head__PuckerLips", 0.531f);


				NewExpression("f");
				AddShapeComponent(new[] {"head__eCTRLvF", "head__VSMF", "head__CTRLVSMF"}, 0.11f, 0f, 0.07f, "head__eCTRLvF", 1f);
				// emotiguy
				AddShapeComponent(new[] {"head__MouthF"}, 0.11f, 0f, 0.07f, "head__MouthF", 1f);
				AddShapeComponent(new[] {"head__MouthTH"}, 0.11f, 0f, 0.07f, "head__MouthTH", 0.231f);


				NewExpression("th");
				AddShapeComponent(new[] {"head__eCTRLvTH", "head__VSMTH", "head__CTRLVSMTH"}, 0.11f, 0f, 0.07f, "head__eCTRLvTH", 1f);
				// emotiguy
				AddShapeComponent(new[] {"head__PuckerLips"}, 0.11f, 0f, 0.07f, "head__PuckerLips", 0.419f);
				AddShapeComponent(new[] {"head__MouthTH"}, 0.11f, 0f, 0.07f, "head__MouthTH", 1f);


				NewExpression("ow");
				AddShapeComponent(new[] {"head__eCTRLvOW", "head__VSMOW", "head__CTRLVSMOW"}, 0.11f, 0f, 0.07f, "head__eCTRLvOW", 1f);
				// emotiguy
				AddShapeComponent(new[] {"head__MouthO"}, 0.11f, 0f, 0.07f, "head__MouthO", 1f);
				AddShapeComponent(new[] {"head__StretchLips"}, 0.11f, 0f, 0.07f, "head__StretchLips", 0.538f);


				NewExpression("ee");
				AddShapeComponent(new[] {"head__eCTRLvEE", "head__VSMEH", "head__CTRLVSMEH"}, 0.11f, 0f, 0.07f, "head__eCTRLvEE", 1f);
				// emotiguy
				AddShapeComponent(new[] {"head__PuckerLipsWide"}, 0.11f, 0f, 0.07f, "head__PuckerLipsWide", 0.762f);
				AddShapeComponent(new[] {"head__StretchLips"}, 0.11f, 0f, 0.07f, "head__StretchLips", 1f);
				AddShapeComponent(new[] {"head__MouthSpeak"}, 0.11f, 0f, 0.07f, "head__MouthSpeak", 0.36f);


				NewExpression("oo");
				AddShapeComponent(new[] {"head__eCTRLvOW", "head__VSMOW", "head__CTRLVSMOW"}, 0.11f, 0f, 0.07f, "head__eCTRLvOW", 1f);
				AddShapeComponent(new[] {"head__eCTRLMouthWide-Narrow"}, 0.11f, 0f, 0.07f, "head__eCTRLMouthWide-Narrow", 1f);
				AddShapeComponent(new[] {"head__eCTRLvAA", "head__VSMAA", "head__CTRLVSMAA"}, 0.11f, 0f, 0.07f, "head__eCTRLvAA", 1f);
				// emotiguy
				AddShapeComponent(new[] {"head__PuckerLipsOOO"}, 0.11f, 0f, 0.07f, "head__PuckerLipsOOO", 0.537f);
				AddShapeComponent(new[] {"head__MouthYell"}, 0.11f, 0f, 0.07f, "head__MouthYell", 0.795f);
